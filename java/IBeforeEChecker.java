...
public class IBeforeEChecker {
  // instance variables - available to every method in this class
  private InputStream source; // source holds instance of InputStream
  private int matchCount;
  private boolean computed;
  private ArrayList<String> wordList;

  public IBeforeEChecker(InputStream source) {
    // give starting values to our instance variables
    matchCount = 0;
    computed = false;
  ...
  private boolean fitsRule(String word) {
    if (word.contains("ie") && ! word.container("cie")) {
      return true;
    }
